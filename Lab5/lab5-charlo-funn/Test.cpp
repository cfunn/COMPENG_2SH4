...
void testCopy2() {
	...
	int arr[] = {0, 1, 2, 3}; // this list
	SLLSet listObj2 =  SLLSet(arr,4);
	SLLSet copied = listObj2.copy();
	string expectedObj2 = "0, 1, 2, 3";
	string expectedCopied = "0, 1, 2, 3";
	int expectedObj2Size = 4;
	int expectedCopiedSize = 4;
...
void testIsInEmpty() {
	...
	SLLSet listObj =  SLLSet();


	int notin = 0; // test isIn
	bool expected = false;

	ASSERT_EQUAL(expected,listObj.isIn(notin));
...
void testAdd5() {
	...
	int addonly = 5;  // test add

	string expectedObj = "5";
	int expectedObjSize = 1;

	listObj.add(addonly);
	ASSERT_EQUAL(expectedObjSize,listObj.getSize());
	ASSERT_EQUAL(expectedObj,listObj.toString());
...
void testRemove5() {
	...
	int arr[] = {1}; // this list
	SLLSet listObj =  SLLSet(arr,1);

	int removeonly = 1;  // test remove

	//test remove

	listObj.remove(removeonly);

	string expectedObj = "";
	int expectedObjSize = 0;
...
void testUnion5() {
	...
	int uni3[] = {1, 2, 3};
	SLLSet listObj3 = SLLSet(uni3,3);
	SLLSet listObj4 = listObj3.setUnion(listObj2);
...
void testIntersection5() {
	...
	int inter3[] = {7}; //test intersection

	SLLSet listObj15 = SLLSet(inter3,1);
	SLLSet listObj16 = listObj2.intersection(listObj15);
...
void testDifference5() {
	...
	int diff[] = {1, 2, 3, 8, 9, 10}; // test difference
	// test difference
	SLLSet listObj21 = SLLSet(diff,6);
	SLLSet listObj22 = listObj2.difference(listObj21);
...
void testUnionSLLSetArray2() {
	...
	int arr5[] = {};
	int arr6[] = {8, 9};
	SLLSet listObj1 = SLLSet(arr1,3);
	SLLSet listObj2 = SLLSet(arr2,1);
	SLLSet listObj3 = SLLSet(arr3,5);
	SLLSet listObj4 = SLLSet(arr4,3);
	SLLSet listObj5 = SLLSet();
	SLLSet listObj6 = SLLSet(arr5,0);
	SLLSet listObj7 = SLLSet(arr6,2);
	SLLSet Array[] = {listObj1, listObj2, listObj3, listObj4, listObj5, listObj6, listObj7}; // test static SLLSet union(sArray)

	SLLSet listObj23 = SLLSet::setUnion(Array,7);
